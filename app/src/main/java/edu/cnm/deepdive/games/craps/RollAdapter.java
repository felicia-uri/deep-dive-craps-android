...
public class RollAdapter extends ArrayAdapter<Game.Roll> {
  ...
  public View getView(int position, View convertView, ViewGroup parent) {
    ...
    ((ImageView) layout.findViewById(R.id.die0View)).setImageDrawable(faces[roll.dice[1] - 1]);
    String outcome;
    int background;
    switch (roll.after) {
      case WIN:
    ...
    ((TextView) layout.findViewById(R.id.rollView))
        .setText(context.getString(R.string.roll_message, roll.dice[0] + roll.dice[1]));
