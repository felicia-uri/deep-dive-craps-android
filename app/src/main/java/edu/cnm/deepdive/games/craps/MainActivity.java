...
public class MainActivity extends AppCompatActivity {
  ...
  private void initializeFields() {
    ...
    for(int i = 0; i < faces.length; i++) {
      int id = res.getIdentifier(DIE_IMAGE_PREFIX + (i + 1),DRAWABLE_RESOURCE_TYPE, getPackageName());
  ...
  private void setTallyMessage(long wins, long plays) {
    ...
    String percentMessage = (plays > 0) ? getString(R.string.winning_percentage, 100.0 * wins /plays) : "";
